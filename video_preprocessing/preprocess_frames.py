...
np.save(open("../matrices/fullbody_lbl_tr_128.npy", "w"), lbl_tr)
...
np.save(open("../matrices/fullbody_img_tr_128.npy", "w"), img_tr)
...
np.save(open("../matrices/fullbody_lbl_vl_128.npy", "w"), lbl_vl)
...
np.save(open("../matrices/fullbody_img_vl_128.npy", "w"), img_vl)
print('val labels loaded with shape: ',img_vl.shape)

##### load test

img_path = '../dataset/Test/FullBody/Subject_{0}_Story_{1}/Subject_img/'
lbl_path = '../dataset/Test/Annotations/Subject_{0}_Story_{1}.csv'

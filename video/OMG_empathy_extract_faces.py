...
def extractFramesFromVideo(path,savePath, faceDetectorPrecision):
    ...
    for video in videos:
        ...
        copyTarget = "/Users/julialu/cpsc490-senior-project/data/Training/Videos/clip1.mp4"
...
if __name__ == "__main__":
    ...
    #Path where the videos are -- Change to where the data file path is in for your computer 

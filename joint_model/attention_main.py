...
#callbacks
save_name = '../checkpoints/joint_model/attention_model2.{epoch:02d}-{val_loss:.2f}.hdf5'
...
att_input = TimeDistributed(Dense(128, activation='relu'))(att_input)
att_weights = TimeDistributed(Dense(2, activation='softmax'))(att_input)
...
layer = TimeDistributed(Dense(512, activation='relu', kernel_initializer='he_uniform'))(fused_features)
layer = TimeDistributed(BatchNormalization())(layer)
layer = TimeDistributed(Dense(256, activation='relu', kernel_initializer='he_uniform'))(layer)
layer = TimeDistributed(Dense(64, activation='relu', kernel_initializer='he_uniform'))(layer)
flat = Flatten()(layer)

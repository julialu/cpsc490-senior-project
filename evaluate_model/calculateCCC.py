...
import math
'''
Compute generalized and personalized empathy tracks. To run this file:
python calculateCCC validationFolder modelOutputFolder

Use the evaluate_model.py script to transform model output to correctly
formatted csv files
'''
